...
let exampleMovie1 = Movie(id: UUID().uuidString, name: "DARK", thumbnailURL: URL(string: "https://picsum.photos/200/300")!, categories: categories, year: 2020, rating: "TV-MA", quality: "HD", numberOfSeasons: 2, episode: exampleEpisodes, defaultEpisodeInfo: currentEpisodeInoExample1, creators: "Netflix, IFlix", cast: "Brad Pitt, Angalina Julie, Ben Afflick, Leonardo Di Caprio, Rock, Brad Smith", moreLikeThisMovie: [exampleMovie2,exampleMovie3,exampleMovie4], trailers: [exampleTrailer1], previewImageName: "arrestedDevPreview", previewVideoURL: exampleVideoURL)
