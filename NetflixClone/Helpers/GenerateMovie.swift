...
func generateEpisodes(_ count: Int, forSeason season: Int) -> [Episode] {
    ...
    for num in 0..<count {
        ...
        let episode = Episode(id: id, episodeNumber: num + 1, name: name, season: season, thumbnailImageURLString: thumbnail, description: desc, length: randLength, videoURL: exampleVideoURL)
